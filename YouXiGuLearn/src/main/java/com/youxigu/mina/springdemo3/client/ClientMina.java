...
import com.youxigu.mina.springdemo3.coder.HCoderFactory;

/**
 * @Description: mina客户端，包含断线重连机制，空闲重连机制
 * @author myg
 * @time 2015年11月27日 下午6:09:37
 */
public class ClientMina extends Thread {

	private final static Log log = LogFactory.getLog(ClientMina.class);
